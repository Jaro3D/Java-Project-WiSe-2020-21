...
public class Datenbank {
    ...
    */
    ...
    public static Notification[] loadNotifications()
    {
        Notification[] notifications;
        if(createNew)
        {
            Date now = NotifikationService.getNow();
            String duration = "zwei Stunden";
            ...
            notifications[0] = new Notification("User1", "give-me-cookies@web.de", "none", "Email-Service test 1", members, address,0,dates[0],duration,0);
            notifications[1] = new Notification("User2", "give-me-cookies@web.de", "none", "Email-Service test 2", members, address,0,dates[1],duration,1);
            notifications[2] = new Notification("User3", "give-me-cookies@web.de", "none", "Email-Service test 3", members, address,0,dates[2],duration,2);
